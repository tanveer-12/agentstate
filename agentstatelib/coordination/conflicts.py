...
class ConflictDetector:
    ...
    def mark_applied(self, target: str) -> None:
        """Remove a patch from pending after
        it has been applied to state.
        Call this after every successful apply_patch
        to prevent stale conflicts
        """
    ...
    def reset(self) -> None:
        """
        Clear all pending patches and conflict records.
        """
        self._pending.clear()
